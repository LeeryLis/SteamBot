...
class PriceAnalysis:
    ...
    def _find_first_available_price(
            self, market_data: dict[str, Any], median_price: float, my_sell_orders: list[SellOrderItem]) -> float:
        acceptable_price = (1 - self.acceptable_price_diff) * median_price
